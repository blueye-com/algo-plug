...
typedef bool	(*i_init)();
typedef void	(*i_dynamic_func_a)(double _arg_input, double &_arg_output);
typedef void	(*i_dynamic_func_b)(std::deque<double> _arg_input, std::deque<double> &_arg_output);
typedef void	(*i_dynamic_func_c)(std::deque< std::deque<double> > _arg_input, std::deque<double> &_arg_output);
typedef void	(*i_dynamic_func_d)(std::deque< std::deque<double> > _arg_input, std::deque< std::deque<double> > &_arg_output);
